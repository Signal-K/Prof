...
export interface SignatureDropInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "approve" | "balanceOf" | "burn" | "claim" | "claimCondition" | "contractType" | "contractURI" | "contractVersion" | "encryptDecrypt" | "getApproved" | "getDefaultRoyaltyInfo" | "getNumOfTokenBatches" | "getPlatformFeeInfo" | "getRevealURI" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getRoyaltyInfoForToken" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "isApprovedForAll" | "isTrustedForwarder" | "lazyMint" | "mintWithSignature" | "multicall" | "name" | "nextTokenIdToMint" | "owner" | "ownerOf" | "primarySaleRecipient" | "renounceRole" | "reveal" | "revokeRole" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setClaimConditions" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setPlatformFeeInfo" | "setPrimarySaleRecipient" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply" | "transferFrom" | "verify" | "verifyClaim" | "verifyClaimMerkleProof"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getNumOfTokenBatches", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getNumOfTokenBatches", data: BytesLike): Result;
    ...
    events: {
        ...
        "TokenLazyMinted(uint256,uint256,string,bytes)": EventFragment;
        "TokenURIRevealed(uint256,string)": EventFragment;
        "TokensClaimed(tuple,address,address,uint256,uint256)": EventFragment;
        "TokensMinted(address,address,uint256,uint256,uint256,address)": EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: "TokenLazyMinted"): EventFragment;
...
export interface TokenLazyMintedEventObject {
    startId: BigNumber;
    amount: BigNumber;
    baseURI: string;
    encryptedBaseURI: string;
}
export declare type TokenLazyMintedEvent = TypedEvent<[
    BigNumber,
    BigNumber,
    string,
    string
], TokenLazyMintedEventObject>;
export declare type TokenLazyMintedEventFilter = TypedEventFilter<TokenLazyMintedEvent>;
...
export interface SignatureDrop extends BaseContract {
    ...
    callStatic: {
        ...
        mintWithSignature(_req: ISignatureMintERC721.MintRequestStruct, _signature: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "TokenLazyMinted(uint256,uint256,string,bytes)"(startId?: BigNumberish | null, amount?: null, baseURI?: string | null, encryptedBaseURI?: null): TokenLazyMintedEventFilter;
        TokenLazyMinted(startId?: BigNumberish | null, amount?: null, baseURI?: string | null, encryptedBaseURI?: null): TokenLazyMintedEventFilter;
        "TokenURIRevealed(uint256,string)"(index?: null, revealedURI?: null): TokenURIRevealedEventFilter;
        TokenURIRevealed(index?: null, revealedURI?: null): TokenURIRevealedEventFilter;
        ...
        "TokensMinted(address,address,uint256,uint256,uint256,address)"(minter?: string | null, receiver?: null, startTokenId?: BigNumberish | null, amountMinted?: null, pricePerToken?: null, currency?: string | null): TokensMintedEventFilter;
        TokensMinted(minter?: string | null, receiver?: null, startTokenId?: BigNumberish | null, amountMinted?: null, pricePerToken?: null, currency?: string | null): TokensMintedEventFilter;
    ...
    populateTransaction: {
        ...
        getNumOfTokenBatches(overrides?: CallOverrides): Promise<PopulatedTransaction>;
