...
class MockProvider extends ethers.providers.BaseProvider {
  ...
  async enable() {
    ...
    if ((_classPrivateFieldGet2 = base._classPrivateFieldGet(this, _options).flags) !== null && _classPrivateFieldGet2 !== void 0 && _classPrivateFieldGet2.failConnect) throw new base.UserRejectedRequestError(new Error('Failed to connect'));
...
class MockConnector extends base.Connector {
  constructor(config) {
    ...
    base._classPrivateMethodInitSpec(this, _switchChain);
  ...
  async connect() {
    ...
    if (!((_this$options$flags = this.options.flags) !== null && _this$options$flags !== void 0 && _this$options$flags.noSwitchChain)) this.switchChain = base._classPrivateMethodGet(this, _switchChain, _switchChain2);
    return data;
  }
